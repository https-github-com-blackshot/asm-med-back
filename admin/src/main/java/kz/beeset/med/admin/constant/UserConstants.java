...
public final class UserConstants {
    ...
    public static final String USER_ROLE_ORG_MAPLIST = "userRoleOrgMapList";
     ...
     *  3 - admin
     */
    public static final String ACCESS_MODE_FIELD_NAME = "accessMode";
    ...
    public static enum USER_COLORS {
        WHITE, PEACHYELLOW, NEWORLEANS, DISERRIA, PETITEORCHID, MAHOGANY
    }
