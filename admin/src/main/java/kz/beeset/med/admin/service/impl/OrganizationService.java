...
import kz.beeset.med.admin.repository.OrganizationRepository;
...
public class OrganizationService implements IOrganizationService {
    ...
    public List<Organization> readButRoot() throws InternalException {
        try {
            List<Organization> organizations = organizationRepository.findAll();

            organizations.removeIf(organization -> organization.getCode().equals("ROOT_ORGANIZATION"));
    ...
    public Page<Organization> read(Query query, Pageable pageableRequest) throws InternalException { //MultiValueMap<String, String> params
        try {
            return organizationRepository.findAll(query, pageableRequest);
        } catch (Exception e) {
            LOGGER.error(e.getMessage(), e);
            throw IE_HELPER.generate(ErrorCode.ErrorCodes.SYSTEM_ERROR, "Exception:-" +
                    "Page<Organization> read(Query query, Pageable pageableRequest)" +
                    "-", e);
        }
    }
...
//    }
    ...
    public Organization updateNew(Organization organization) throws InternalException {
        try {
            Organization curOrg = organizationRepository.getById(organization.getId());
            organization.setState(curOrg.getState());
