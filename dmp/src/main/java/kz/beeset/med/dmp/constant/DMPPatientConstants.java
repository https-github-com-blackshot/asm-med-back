...
public class DMPPatientConstants {
    ...
    public final static int DEFAUT_PAGE_SIZE = 100;
    ...
    public final static String CODE_NUMBER_FIELD_NAME = "codeNumber";

    public final static String DMP_DOCTOR_IDS_FIELD_NAME = "dmpDoctorIds";

    public final static String HEALTH_STATUS_FIELD_NAME = "healthStatus";
