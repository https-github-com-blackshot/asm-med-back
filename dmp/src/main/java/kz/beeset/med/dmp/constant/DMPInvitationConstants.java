...
public class DMPInvitationConstants {
    ...
    public final static String PATIENT_USER_ID_FIELD_NAME = "patientUserId";

    public final static String MESSAGE_FIELD_NAME = "message";

    public final static String INVITATION_STATUS_FIELD_NAME = "invitationStatus";
    ...
    public final static int STATUS_RECALLED = 4;
