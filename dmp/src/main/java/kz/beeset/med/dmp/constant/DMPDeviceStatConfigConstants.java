...
public class DMPDeviceStatConfigConstants {
    ...
    public final static String PARAMETER_MAP_FIELD_NAME = "parameterMap";

    public final static String DMP_ID_FIELD_NAME = "dmpId";

    public final static String DMP_PATIENT_ID_FIELD_NAME = "dmpPatientId";

    public final static String DMP_PATIENT_USER_ID_FIELD_NAME = "dmpPatientUserId";
