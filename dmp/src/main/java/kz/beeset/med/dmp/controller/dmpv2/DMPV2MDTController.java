...
import kz.beeset.med.dmp.service.dmpv2.IDMPV2MDTEventService;
import kz.beeset.med.dmp.service.dmpv2.IDMPV2MDTTemplateService;
...
@RestController
@RequestMapping("dmpv2/mdt")
@Api(tags = {"DMPV2MDT"}, description = "DMPV2MDT", authorizations = {@Authorization(value = "bearerAuth")})
public class DMPV2MDTController extends CommonService {

    private static final Logger LOGGER = LoggerFactory.getLogger(DMPV2MDTController.class);

    @Autowired
    private IDMPV2MDTTemplateService dmpmdtTemplateService;
    @Autowired
    private IDMPV2MDTEventService dmpmdtEventService;
    ...
    @ApiOperation(value = "Получить список всех DMPV2MDTTemplate", tags = {"DMPMDT"})
    @RequestMapping(value = "read/dmp/mdtTemplateiterable/{diseaseId}", method = RequestMethod.GET, produces = "application/json")
    public ResponseEntity<?> getDMPMDTTemplateIterable(@PathVariable(name = "diseaseId") String diseaseId) {
        try {
            return builder(success(dmpmdtTemplateService.readIterableByDiseaseId(diseaseId)));
        } catch (InternalException e) {
            LOGGER.error(e.getMessage(), e);
            return builder(errorWithDescription(e.getErrorRef(), e.getMessage()));
        }
    ...
    @ApiOperation(value = "Получить DMPV2MDTTemplate по заданному ID", tags = {"DMPMDT"})
    ...
    @ApiOperation(value = "Получить DMPV2MDTTemplate по заданному userID", tags = {"DMPMDT"})
    ...
    @ApiOperation(value = "Создать объект DMPV2MDTTemplate", tags = {"DMPMDT"})
    @RequestMapping(value = "create/dmp/mdtTemplate", method = RequestMethod.POST, produces = "application/json")
    public ResponseEntity<?> createDMPMDTTemplate(@RequestBody @Valid DMPV2MDTTemplate dmpmdtTemplate) {
        try {
    ...
    @ApiOperation(value = "Обновить объект DMPV2MDTTemplate", tags = {"DMPMDT"})
    @RequestMapping(value = "update/dmp/mdtTemplate", method = RequestMethod.PUT, produces = "application/json")
    public ResponseEntity<?> updateDMPMDTTemplate(@RequestBody @Valid DMPV2MDTTemplate dmpmdtTemplate) {
        try {
    ...
    @ApiOperation(value = "Получить объект/список DMPV2MDTEvent по параметрам", tags = {"DMPMDT"})
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", dataType = "string", value = "Возвращает объект с данным id", paramType = "query"),
            @ApiImplicitParam(name = "dmpId", dataType = "string", value = "Возвращает список объектов с данным ID пуза", paramType = "query"),
            @ApiImplicitParam(name = "teamId", dataType = "string", value = "Возвращает список объектов с данным ID команды", paramType = "query"),
            @ApiImplicitParam(name = "ownerId", dataType = "string", value = "Возвращает список объектов с данным ID инициатора", paramType = "query"),
            @ApiImplicitParam(name = "diseaseVisitId", dataType = "string", value = "Возвращает список объектов с данным ID визита", paramType = "query"),
            @ApiImplicitParam(name = "diseaseUserId", dataType = "string", value = "Возвращает список объектов с данным ID пациента", paramType = "query"),
    ...
    @ApiOperation(value = "Получить объект/список DMPV2MDTEventCustom по параметрам", tags = {"DMPMDT"})
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", dataType = "string", value = "Возвращает объект с данным id", paramType = "query"),
            @ApiImplicitParam(name = "dmpId", dataType = "string", value = "Возвращает список объектов с данным ID пуза", paramType = "query"),
            @ApiImplicitParam(name = "teamId", dataType = "string", value = "Возвращает список объектов с данным ID команды", paramType = "query"),
    ...
    @ApiOperation(value = "Получить список всех DMPV2MDTEvent", tags = {"DMPMDT"})
    @RequestMapping(value = "/read/dmp/mdtEvent/one/{diseaseId}", method = RequestMethod.GET, produces = "application/json")
    public ResponseEntity<?> getDMPMDTEventIterable(@PathVariable(name = "diseaseId") String diseaseId) {
        try {
            return builder(success(dmpmdtTemplateService.readIterableByDiseaseId(diseaseId)));
        } catch (InternalException e) {
            LOGGER.error(e.getMessage(), e);
    ...
    @ApiOperation(value = "Получить DMPV2MDTEvent по заданному ID", tags = {"DMPMDT"})
    ...
    @ApiOperation(value = "Получить DMPV2MDTEvent по заданному userID", tags = {"DMPMDT"})
    ...
    @ApiOperation(value = "Создать объект DMPV2MDTEvent", tags = {"DMPMDT"})
    @RequestMapping(value = "/create/dmp/mdtEvent", method = RequestMethod.POST, produces = "application/json")
    public ResponseEntity<?> createDMPMDTEvent(@RequestBody @Valid DMPV2MDTEvent dmpmdtEvent) {
        try {
    ...
    @ApiOperation(value = "Обновить объект DMPV2MDTEvent", tags = {"DMPMDT"})
    @RequestMapping(value = "/update/dmp/mdtEvent", method = RequestMethod.PUT, produces = "application/json")
    public ResponseEntity<?> updateDMPMDTEvent(@RequestBody @Valid DMPV2MDTEvent dmpmdtEvent) {
        try {
    ...
    @ApiOperation(value = "Accept DMPV2MDTEvent by doctor", tags = {"DMPMDT"})
    ...
    @ApiOperation(value = "Decline DMPV2MDTEvent by doctor", tags = {"DMPMDT"})
    ...
    @ApiOperation(value = "Создать объект DMPV2MDTEventComment", tags = {"DMPMDT"})
    @RequestMapping(value = "/create/dmp/mdtEventComment", method = RequestMethod.POST, produces = "application/json")
    public ResponseEntity<?> createDMPMDTTemplate(@RequestBody @Valid DMPV2MDTEventComment eventComment) {
        try {
    ...
    @ApiOperation(value = "Получить список всех DMPV2MDTEventComment по event id", tags = {"DMPMDT"})
    ...
    @ApiOperation(value = "Обновить объект " +
            " adding commentId", tags = {"DMPMDT"})
